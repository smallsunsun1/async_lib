...
class DeviceMemory {
 public:
  ...
  DeviceMemory(T* ptr, DeviceType dType) : mPair(ptr, type) {}
  ...
  DeviceMemory operator+(std::ptrdiff_t offset) const {
    return DeviceMemory(Pointer() + offset, platform());
  }
  DeviceMemory operator-(std::ptrdiff_t offset) const {
    return DeviceMemory(Pointer() - offset, platform());
  }
 ...
 private:
  ...
  typename std::conditional<
      ...
      llvm::PointerIntPair<T*, 2, DeviceType>, PointDeviceTypePair>::type
